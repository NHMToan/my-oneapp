  ...
  return (
    <div>
      ...
      <Typography variant="body1" paragraph>
        ...
        policies that may be posted on the website from time to time. If you do
        not agree to these terms, please refrain from using the website.
      </Typography>
      ...
      <Typography variant="body1" paragraph>
        When using this website, you agree to abide by the following guidelines:
      </Typography>
      <List>
        <ListItem>
          <ListItemText
      ...
      <Typography variant="body1" paragraph>
        ...
        operation or the accuracy, reliability, or completeness of the content.
        We shall not be held responsible for any damages resulting from the use
      ...
      <Typography variant="body1" paragraph>
        ...
        or in connection with the use of this website, even if we have been
